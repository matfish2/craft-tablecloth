...
export default {
    ...
    async getData(resetPagination = false) {
        ...
        let dataRes = await axios.post(`/?action=tablecloth/site-data/get-data&${params}`);
        ...
        let countRes = await axios.post(`/?action=tablecloth/site-data/get-count&${countParams}`);
